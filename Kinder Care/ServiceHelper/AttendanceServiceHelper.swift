...
class AttendanceServiceHelper {
  ...
  class func requestFormData<T: Codable>(router: AttendanceServiceManager, completion: @escaping (Result<T, CustomError>) -> ()) {
  ...
  class func request<T: Codable>(router: AttendanceServiceManager, completion: @escaping (Result<T, CustomError>) -> ()) {
