//
//  EnrolmentEnquiryServiceHelper.swift
//  Kinder Care
//
...
class EnrolmentEnquiryServiceHelper {
    
    class func requestFormData<T: Codable>(router: EnrolmentEnquiryServiceManager, completion: @escaping (Result<T, CustomError>) -> ()) {
    ...
    class func request<T: Codable>(router: EnrolmentEnquiryServiceManager, completion: @escaping (Result<T, CustomError>) -> ()) {
