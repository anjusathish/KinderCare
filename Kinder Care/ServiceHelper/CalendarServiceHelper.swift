...
class CalendarServiceHelper {
    ...
    class func requestFormData<T: Codable>(router: CalendarServiceManager, completion: @escaping (Result<T, CustomError>) -> ()) {
    ...
    class func request<T: Codable>(router: CalendarServiceManager, completion: @escaping (Result<T, CustomError>) -> ()) {
