...
class ReportServiceHelper {
    ...
    class func requestFormData<T: Codable>(router: ReportServiceManager, completion: @escaping (Result<T, CustomError>) -> ()) {
    ...
    class func request<T: Codable>(router: ReportServiceManager, completion: @escaping (Result<T, CustomError>) -> ()) {
