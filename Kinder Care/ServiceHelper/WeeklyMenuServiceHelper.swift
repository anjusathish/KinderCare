...
class WeeklyMenuServiceHelper {
    
    class func requestFormData<T: Codable>(router: WeeklyMenuServiceManager, completion: @escaping (Result<T, CustomError>) -> ()) {
    ...
    class func request<T: Codable>(router: WeeklyMenuServiceManager, completion: @escaping (Result<T, CustomError>) -> ()) {
