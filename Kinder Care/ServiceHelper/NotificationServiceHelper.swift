...
class NotificationServiceHelper {
    ...
    class func requestFormData<T: Codable>(router: NotificationServiceManager, completion: @escaping (Result<T, CustomError>) -> ()) {
    ...
    class func request<T: Codable>(router: NotificationServiceManager, completion: @escaping (Result<T, CustomError>) -> ()) {
